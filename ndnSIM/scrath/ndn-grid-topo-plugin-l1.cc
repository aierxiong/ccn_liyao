...
main (int argc, char *argv[])
{
  ...
  topologyReader.SetFileName ("src/ndnSIM/examples/topologies/topo-grid-3x3-l.txt");
  topologyReader.Read ();
...
//20160114 start right
 ndn::AppHelper consumerHelper ("ns3::ndn::ConsumerCbr");
//20160114 end right
  //20160114 start change
  ...
  consumerHelper.SetAttribute ("Frequency", StringValue ("1")); // 100 interests a second
   //20160114 start
  consumerHelper.SetAttribute ("ConsumerNumberOfContents", StringValue ("100")); 
  //20160114 end
