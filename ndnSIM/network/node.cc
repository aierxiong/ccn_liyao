...
Node::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::Node")
    ...
    .AddAttribute ("SystemId", "The systemId of this node: a unique integer used for parallel simulations.",
                   ...
                   MakeUintegerChecker<uint32_t> ())
    // edit start
    // .AddAttribute ("Preference", "The preference of this node: a unique preference value for request arrival rate.",
    //                TypeId::ATTR_GET|TypeId::ATTR_SET,
    //                UintegerValue (0.0),
    //                MakeUintegerAccessor (&Node::m_preference),
    //                MakeUintegerChecker<double> ())
    // edit end
    //20160113 strat 
     .AddAttribute ("betw", "This Node betw data.",
                   TypeId::ATTR_GET|TypeId::ATTR_SET,
                   UintegerValue (0.0),
                   MakeUintegerAccessor (&Node::m_betw),
                   MakeUintegerChecker<double> ())
     //20160113 end
  ;
  return tid;
...
// edit start
// Node::Node(uint32_t sid, double preference)
//   : m_id (0),
//     m_sid (sid),
...
//      //20160113 end 
// { 
//   NS_LOG_FUNCTION (this << sid << preference);
//   Construct ();
// }
// edit end 
...
//20160113 replacerate start
void
Node::SetReplaceRate(double replaceRate)
{
  m_replaceRate = replaceRate;
}

double 
Node::GetReplaceRate(void) const
{
  return m_replaceRate;
}
//20160113 replacerate end
