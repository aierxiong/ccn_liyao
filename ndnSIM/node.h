...
public:
  ...
  Node(uint32_t systemId);
    // edit start
  // Node(uint32_t systemId, double preference);
  // edit end
  ...
  //edit start
  // double  GetPreference (void) const;
  //edit end

//20160113 betw start
  void  SetBetw (double betw);
  double GetBetw (void) const;
//20160113 betw end


  //20160113 replacerate start
  void SetReplaceRate(double replaceRate);
  double GetReplaceRate(void) const;
