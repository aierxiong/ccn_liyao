...
protected:
  ...
  // edit  start 
  // Ptr<Node>
  // CreateNode (const std::string name, double posX, double posY, uint32_t systemId, double preference);
  // edit  end

  //20160113 start
  Ptr<Node>
  CreateNode (const std::string name, double posX, double posY, uint32_t systemId, double Betw);
  //20160113 end
protected:
  /**
