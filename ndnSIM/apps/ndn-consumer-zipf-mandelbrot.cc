...
ConsumerZipfMandelbrot::SendPacket() {
  ...
  //liyao20150714
  interest->SetSeq (seq);
  m_currentsequence=interest->GetSeq ();
  //liyao20150714 end
  ...
  std::cout<<"m_currentsequence  "<<m_currentsequence<<std::endl;
    //liyao20150713
...
//liyao20150713
// uint32_t
// ConsumerZipfMandelbrot::GetCurrentsequence()
// {return 
//   m_currentsequence;
// }
//liyao20150713 end
