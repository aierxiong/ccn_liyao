...
Interest::GetSerializedSize (void) const
{
  size_t size =
    ...
    (4/*nonce*/ + 1/*scope*/ + 1/*nack type*/ + 2/*timestamp*/ + 4/*preference*/+4/*sequence*/ +
...
Interest::Serialize (Buffer::Iterator start) const
{
  ...
  //edit  start
  start.WriteU32 (m_interest->GetPreference ());
  //edit end

  //20160107liyao start
  // start.WriteU32 (m_interest->GetHopmax ());
  //20160107liyao end

  //liyao20150714
  start.WriteU32 (m_interest->GetSeq ());
  //liyao20150714 end
...
Interest::Deserialize (Buffer::Iterator start)
{
  ...
  //edit start
  m_interest->SetPreference (i.ReadU32 ());
  //edit end

  //liyao20160107
  // m_interest->SetHopmax (i.ReadU32 ());
  //liyao20160107

  //liyao20150714
  m_interest->SetSeq (i.ReadU32 ());
  //liyao20150714 end
